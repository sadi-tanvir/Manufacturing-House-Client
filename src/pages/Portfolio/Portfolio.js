...
const Portfolio = () => {
    return (
        <div className="w-screen flex justify-center items-center bg-slate-50">
            <div className="w-full md:w-10/12 my-24 pb-10 rounded-3xl bg-slate-100 shadow-xl flex flex-col justify-center items-center">
                ...
                <div>
                    ...
                    <p className="text-md text-slate-600 font-semibold text-center">Web Developer</p>
                </div>
                ...
                <div className="flex flex-col justify-center items-center px-14 w-full ">
                    ...
                    {/* technology start */}
                    <div className="w-full flex justify-center items-center justify-evenly mt-10">
